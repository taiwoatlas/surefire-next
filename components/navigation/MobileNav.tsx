...
/**
 * Real focus management, not a stub: traps focus while open, restores it
 * to the trigger button on close, locks background scroll, and closes on
 * Escape — see 00BB/00BK.
 */
