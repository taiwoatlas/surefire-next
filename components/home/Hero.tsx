...
export function Hero() {
  const nextService = services[0]!; // In His Presence — Sunday, the primary weekly gathering
  ...
  return (
    <section className="relative flex min-h-[92vh] flex-col justify-end overflow-hidden bg-ink pb-16 pt-40 text-paper">
      <div className="mx-auto w-full max-w-[1240px] px-6 md:px-10">
        ...
        {/* Service micro-panel — next gathering, visible without dominating the hero */}
